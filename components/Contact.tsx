...
export default function Contact() {
  return (
    <section className="px-4 py-16 sm:px-6 sm:py-20 lg:py-24" id="contato">
      <div className="mx-auto max-w-[1180px] rounded-[32px] border border-white/10 bg-[#0b1019] p-8 sm:p-10 lg:p-12">
        <div className="grid items-end gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-16">
          ...
          <div className="rounded-[24px] border border-white/10 bg-[#080a11] p-6 lg:text-right">
            <a href={whatsapp} target="_blank" rel="noopener noreferrer" className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-accent px-5 py-4 text-sm font-bold text-black transition-colors hover:bg-white sm:w-auto sm:px-7">
              <Icon name="chat" className="size-5" /> Enviar mensagem <span aria-hidden="true">↗</span>
            </a>
